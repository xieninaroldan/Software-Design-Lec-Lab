     ...
     <body>
         ...
         <nav>
             <ul>
                 ...
                 <li><a href="SERVICESADMIN.php" class="active">Services</a></li>
             </ul>
         </nav>
     ...
     function displayService($row) {
         ...
         $imageSrc = 'http://localhost/modules/uploads/' . $imageFileName; // Adjust the URL as needed
         ...
         <li id="service{$row['service_id']}" data-service-id="{$row['service_id']}" data-service-name="{$row['service_name']}" data-service-price="{$row['orig_price1']}" data-service-price-max="{$row['orig_price2']}" data-service-category="{$row['service_category']}" data-service-description="{$row['service_description']}" data-service-image="{$imageSrc}">
             ...
             <div>
                 ...
                 <button class="btn btn-primary" onclick="editService({$row['service_id']})">Edit</button>
     ...
     ?>
 <button class="btn btn-success" data-toggle="modal" data-target="#addServiceModal">Add New Service</button>
 </div>
...
<div class="modal fade" id="promoModal" tabindex="-1" aria-labelledby="promoModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="promoModalLabel">Add/Remove Promo</h5>
        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="promoForm">
          <div class="mb-3">
            <label for="promoPercent" class="form-label">Promo Percentage Discount</label>
 ...
 function deleteServiceConfirmed(serviceId) {
     ...
     $.post("delete_service.php?service_id=" + serviceId.replace("service","") ,function(d){
...
function submitPromo() {
  ...
  xhr.open('POST', 'add_remove_promo.php', true);
  ...
  xhr.send('serviceId=' + encodeURIComponent(serviceId) + '&promoPercent=' + encodeURIComponent(promoPercent));
}
